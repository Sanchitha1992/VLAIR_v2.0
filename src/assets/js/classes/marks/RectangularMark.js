var RectangularMark = fabric.util.createClass(fabric.Rect, {
    ...
    initialize: function (options) {
        ...
        var areaValue = null;
        var angleValue = null;
      var positionXValue = null;
      var positionYValue = null;
        if (options.values) {
          ...
          positionXValue = createNumericValue(this.left, null, null, 'pixels');
          positionYValue = createNumericValue(this.top, null, null, 'pixels');
        }
      ...
      this.specificProperties.push({ attribute: "left", readable: true, writable: true, types: ['number'], updatesTo: [], dataTypeProposition: 'isNumericData', value: positionXValue });
      this.specificProperties.push({ attribute: "top", readable: true, writable: true, types: ['number'], updatesTo: [], dataTypeProposition: 'isNumericData', value: positionYValue });
