...
var Mark = function () {
    ...
    this.set('propertiesSeparation', 40);
...
//        theMark.changeColors(fillColor, strokeColor);
        ...
        fabric.util.animate({
            ...
            onComplete: function () {
                ...
                if (activateEventsAfterAnimation) {
                    ...
                    gestureSetEnabled(managerr, 'pan1Finger', true);
                }
    ...
    this.expand = function (refreshCanvas) {
        ...
        gestureSetEnabled(managerr, 'pan1Finger', false);
...
//        var duration = 500;
      ...
      var newHeight = (theMark.visualProperties.length * ( theMark.propertiesRadius + 20) + boundingRect.height + 2 * theMark.indent)/2;
      ...
      var newWidth = 150;
      var newTop = (theMark.top + theMark.height+10 + (newHeight / 2 - boundingRect.height / 2 - theMark.indent));
...
//            drawRectAt(new fabric.Point(500, xVisPropMaxY), 'blue');
        ...
        var i = 0;
        theMark.visualProperties.forEach(function (visualProperty,index) {

          var x = theMark.left-40 + ((i % 3) * (theMark.width + theMark.propertiesRadius));
          var y = boundingRectCenterBottom.y + (Math.floor(i / 3) * 50)+10;
        ...
        for (var i = 0; i < theMark.visualProperties.length; i++) {
            ...
            theMark.animateVisualProperty(i, 'scaleX', .7, duration, easing, false, false, false, false);
            theMark.animateVisualProperty(i, 'scaleY', .7, duration, easing, false, false, false, false);
    ...
    this.compress = function (refreshCanvas) {
        ...
        // Disabling any event for this mark. This will be enabled once the animations of this method are done.
        theMark.evented = false;
        gestureSetEnabled(managerr, 'pan1Finger', false); // Disabling the panning functionality while the mark is compressing 
