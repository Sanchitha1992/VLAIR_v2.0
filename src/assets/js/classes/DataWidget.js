...
// Set another completion function for the request above
    ...
    addVariable: function (canvasCoords, variableName) {
        ...
        var theDataWidget = this;
        var valuesArray = theDataWidget.data[variableName][0];
        var typeProposition = valuesArray.getTypeProposition();
            ...
            'mouseup': function (option) {
                ...
                if (targetObject) {
                    ...
                    if (targetObject !== namedCollection && !targetObject.isDataWidget) {                        
                        ...
                        } else if (targetObject.isFunctionValuesCollection || targetObject.isRangeLimit || targetObject.isVisualProperty || targetObject.isFunctionInput || targetObject.isVisualValue || targetObject.isMapperInput || targetObject.isNumericFunctionInput || targetObject.isOperator) {
